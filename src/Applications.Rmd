...
Lastly, let's visualize the real-time car park availability. We will need an additional package, [leaflet](https://rstudio.github.io/leaflet/).
...
leaflet(df_carpark) %>%
  ...
  addCircleMarkers(lng = ~long, lat = ~lat,
                   ...
                   radius = ~AvailableLots/100, stroke = FALSE, 
                   fillOpacity = 0.5, color = "lightseagreen")
```
